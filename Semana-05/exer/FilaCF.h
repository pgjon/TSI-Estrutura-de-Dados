...
void exibeTracos(); // procedimento para separ em linha as informações
...
int pesquisaValida(FilaCF fila, int cod); // função para pesquisar um código existente na fila, sem remover
                                          // do no nodo
